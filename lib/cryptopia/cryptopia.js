...
Cryptopia.prototype.getBalance = function getBalance(callback, symbol)
{
    var params = {};
    if(symbol) params.Currency = symbol

    console.log(params);
    this.privateRequest("GetBalance", params, callback)
}

Cryptopia.prototype.getDepositAddress = function getDepositAddress(callback, symbol)
{
    var params = {};
    if(symbol) params.Currency = "BTC";  //.Currency = symbol

    console.log(params);
    this.privateRequest("GetDepositAddress", params, callback)
}
